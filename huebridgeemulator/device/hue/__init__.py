...
def discover_hue(registry):
    """Discover Hue lights on your local network."""
    pass
...
def addHueMotionSensor(uniqueid):
    ...
    bridge_config["sensors"][new_sensor_id] = {
        ...
        "uniqueid": uniqueid + ":56:d0:5b-02-0402",
        "type": "ZLLTemperature",
        ...
        "config": {
            ...
            "pending": []},
        "modelid": "SML001"}
    bridge_config["sensors"][str(int(new_sensor_id) + 1)] = {
        "name": "Entrance Lights sensor",
        "uniqueid": uniqueid + ":56:d0:5b-02-0406",
        "type": "ZLLPresence",
        "swversion": "6.1.0.18912",
        "state": {
            "lastupdated": "none",
        ...
        "config": {
            ...
            "pending": []},
        "modelid": "SML001"}
    bridge_config["sensors"][str(int(new_sensor_id) + 2)] = {
        "name": "Hue ambient light sensor 1",
        "uniqueid": uniqueid + ":56:d0:5b-02-0400",
        "type": "ZLLLightLevel",
        "swversion": "6.1.0.18912",
        "state": {
            "dark": True,
