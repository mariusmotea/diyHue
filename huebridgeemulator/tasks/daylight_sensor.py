...
def daylight_sensor(registry, sensors_state):
    """???
    ...
    loc = Location(('Current',
                    registry.config["timezone"].split("/")[1],
                    float(registry.sensors["1"].config["lat"][:-1]),
                    float(registry.sensors["1"].config["long"][:-1]),
                    registry.config["timezone"], 0))
